from team21_A3.helper_functions import calculate_new_game_board, is_board_full
from team21_A3.evaluation import evaluate_move
from team21_A3.heuristics.hidden_twin_exclusion import hidden_twin_exclusion
from team21_A3.heuristics.only_square2 import only_square
...
class Node:
    ...
    def evaluate(self):
        ...
        self.score = evaluate_move(
            self.game_board, self.move, self.our_move, self.score)
...
class Tree:
    ...
    def __init__(self, root_moves, taboo_moves, future_taboo_move, cur_game_board, init_score):
        ...
        for cur_move in root_moves:
            ...
            cur_node = Node(score=init_score, move=cur_move,
                            game_board=new_game_board, our_move=True)
            cur_node.evaluate()
        ...
        if future_taboo_move is not None:
            future_taboo_node = Node(
                score=init_score, move=future_taboo_move, game_board=cur_game_board, our_move=True)
    ...
    def add_children_to_root(self, parent_node: Node):
        ...
        if len(parent_node.children) > 0:
            ...
            if parent_node.full_board:
                ...
                non_taboo_moves, future_taboo_move = get_heuristic_moves(
                    parent_node.game_board, self.taboo_moves)
                for cur_move in non_taboo_moves:
                    ...
                    cur_game_board = calculate_new_game_board(
                        parent_node.game_board, cur_move)
    ...
    def find_best_move(self):
        ...
        for root_node in self.root:
            ...
            if root_node.score > best_score:
                ...
                best_node = root_node
        # Just some extra printing so you can easily keep track
...
def get_heuristic_moves(game_board: SudokuBoard, taboo_moves):
    ...
    heuristic_filtered, heuristic_taboo = hidden_twin_exclusion(
        game_board, filtered_moves)
