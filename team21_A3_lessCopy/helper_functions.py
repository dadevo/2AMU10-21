...
def do_move(game_board: SudokuBoard, move: Move):
    """
    Applies a move to the Sudoku board
    @param game_board: The current Sudoku board of type SudokuBoard
    @param move: The current move of type Move we want to do
    """
    game_board.put(move.i, move.j, move.value)
    return game_board


def undo_move(game_board: SudokuBoard, move: Move):
    """
    Undoes a move made to the Sudoku board, mainly for performance reasons (copying is expensive)
    @param game_board: The current Sudoku board of type SudokuBoard
    @param move: The current move of type Move we want to undo
    """
